...
def finalize(state: AgentState) -> AgentState:
    ...
    if intent == "reply":
        ...
        if cits:
            ...
            state.final_text = state.draft_v1.strip() or "Je ne peux pas répondre à cette demande."  # TODO: fallback reply

    elif intent == "ask_clarification":
        state.final_kind = "clarification"
        state.final_text = state.draft_v1.strip() or "Pourriez-vous préciser votre demande ?"  # TODO: fallback questions
        ...
        state.actions.append({
            ...
            "summary": "Escalade automatique : risque ou complexité détectée.",
        ...
        state.final_text = "Message ignoré (hors périmètre ou spam)."  # TODO: texte minimal ignore
